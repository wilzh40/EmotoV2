import { AgentEndMessage, AgentTranscriptMessage, AudioEncoding, AudioMessage, AudioOutputMessage, Channels, Config, JSONMessage, LanguageModelOption, TTSService, TimeSlice, UserInterruptionMessage, UserTranscriptMessage, VoiceProvider, VoiceProviderProps } from '@humeai/voice';
// import {
//     base64ToBlob,
//     checkForAudioTracks,
//     createConfig,
...
(async () => {
     ...
     */
    let client: VoiceProviderProps | null = null;
    /**
